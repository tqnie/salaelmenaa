                        ...
                        <div class="step__content">
                            <div class="step__content1">
                                ...
                                <div class="step__content1--content">
                                   ...
                                   <p> لمتجرك اشترك في المنتج المعروض <br />الذي تبيع او شارك بمنتجك في منصة سلة الميناء </p>
                                </div>
                            </div>
                            <div class="step__content2">
                                ...
                                <div class="step__content2--content">
                                   <h4>سيشترك</h4>
<<<<<<< HEAD
                                   <p>سيشترك المستأجرين في المنتج الذي اخترته
=======
                                   <p>سيشترك المشترين <br> في المنتج الذي اخترته
>>>>>>> parent of 3040059 (سي)
                                   </p>
                                </div>
                            </div>
                            <div class="step__content3">
                                ...
                                <div class="step__content3--content">
                                    <h4>ادخل على المستأجر</h4>
                                    <p> واضف فيديو له واعرض عروضك <br> عليه باضافة فيديوهات كذلك طرق التواصل بك
                                    </p>
                                </div>
                            </div>
...
<<<<<<< HEAD
                                    <h4>سيتجاوب المستأجر</h4>
                                    <p>    ويضيف فيديو لك ويطلب شراء المنتج منك
=======
                                    <h4>سيتجاوب المشتري</h4>
                                    <p>    ويضيف فيديو لك <br>ويطلب شراء المنتج منك
>>>>>>> parent of 3040059 (سي)
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="step__content2">
                                ...
                                <div class="step__content2--content">
                                   <h4> اشحن الطلب </h4>
<<<<<<< HEAD
                                   <p> للمستأجر عبر شركات الشحن مثل سمسا او ارامكس      
=======
